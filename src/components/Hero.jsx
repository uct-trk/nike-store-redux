      ...
      <div className="relative h-auto w-auto flex flex-col">
        ...
        <div className="relative opacity-100 z-20 grid items-center justify-items-center nike-container">
          <div className="grid items-center justify-items-center mt-28 md:mt-24">
            ...
            <h1 className="text-6xl lg:text-5xl md:text-4xl sm:text-3xl xsm:text-2xl font-extrabold filter drop-shadow-sm text-slate-200 mt-1">
              {subtitle}
            </h1>
            <button
              type="button"
            ...
            <div className="grid items-center gap-5 md:gap-5 absolute top-[33vh] lg:top-[27vh] left-[11%] xl:left-0 w-auto h-auto">
